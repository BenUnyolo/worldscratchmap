...
const Nav = () => {
    ...
    const renderAuthRoutes = () => {
        if (userData.user) {
            return (
                <>
                    <Link to="/map" className="nav-link mr-4">My Map</Link>
                    <Link to="/editmap" className="nav-link">Edit Map</Link>
                </>
            )
        }
    }
    ...
    return (
        <nav id="navBar" className="flex items-center justify-between flex-wrap bg-primary-500 p-4">
            <div className="flex items-center flex-shrink-0 text-white mr-6">
                {logo}
                <Link to="/" className="font-semibold text-xl tracking-tight">WorldScratchMap</Link>
            </div>
            ...
            <div className={(showMenu ? "" : "hidden ") + "w-full block flex-grow lg:flex lg:items-center lg:w-auto"}>
                <div className="text-sm lg:flex-grow">
                    ...
                    {renderAuthRoutes()}
                    {/* <a href="#responsive-header" className="nav-link">Blog</a> */}
                </div>
                <AuthOptions />
                {/* <div>
                    <Link to="#" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-primary-500 hover:bg-white mt-4 mr-2 lg:mt-0">Register</Link>
                    <Link to="#" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-primary-500 hover:bg-white mt-4 lg:mt-0">Log In</Link>
                </div> */}
            </div>
        </nav>
    )
